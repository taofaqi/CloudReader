...
public class ItemDoubanTopBinding extends android.databinding.ViewDataBinding  {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 2 :
                return onChangeRatingBean((com.example.jingbin.cloudreader.bean.moviechild.RatingBean) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeRatingBean(com.example.jingbin.cloudreader.bean.moviechild.RatingBean ratingBean, int fieldId) {
        switch (fieldId) {
            case BR.average: {
                synchronized(this) {
                        mDirtyFlags |= 0x20L;
    ...
    protected void executeBindings() {
        ...
        com.example.jingbin.cloudreader.bean.moviechild.RatingBean ratingBean = null;
        ...
        if ((dirtyFlags & 0x53L) != 0) {
            ...
            com.example.jingbin.cloudreader.utils.ImgLoadUtil.showMovieImg(this.ivTopPhoto, largeImagesBean);
        }
        if ((dirtyFlags & 0x49L) != 0) {
            // api target 1
